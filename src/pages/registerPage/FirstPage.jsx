...
const RegisterPage = function () {
  ...
  return (
    ...
    >
          ...
          >
            {(values) => (
              <Form className="formWrapper">
                ...
                <div className="fieldWrapper">
                  {" "}
                  <label className="placeholder" htmlFor="contact">
                    Contact No:
                  </label>
                  <Field
                    autoComplete="off"
                ...
                <div className="fieldWrapper">
                  {" "}
                  <label className="placeholder" htmlFor="address">
                    Address:
                  </label>
                  <Field
                    autoComplete="off"
                ...
                <div className="fieldWrapper">
                  {" "}
                  <label className="placeholder" htmlFor="checkin">
                    Check in:
                  </label>
                  <Field
                ...
                <div className="fieldWrapper">
                  {" "}
                  <label className="placeholder" htmlFor="checkout">
                    Check out:
                  </label>
                  <Field
                    className="input-text calender"
                ...
                <div className="fieldWrapper">
                  <label>
                    <Field
                      ...
                      type="checkbox"
                      value="true"
                      style={{ translate: "-10% 20%", scale: "1.25" }}
                    />
                    <span className="acknowledgement">
                      I accept the{" "}
                      <a href="/pdf/stayingCharges.pdf" target={"_blank"}>
      ...
      {category == "guest" && (
        <RegisterGuest previousvalue={firstPageValue.current} />
      )}
      {category == "alumini" && (
        <RegisterAlumni previousvalue={firstPageValue.current} />
      )}
      {category == "participant" && (
        <RegisterParticipants previousvalue={firstPageValue.current} />
      )}
      {category == "sponsor" && (
        <RegisterSponsors previousvalue={firstPageValue.current} />
      )}
    </div>
  );
};
